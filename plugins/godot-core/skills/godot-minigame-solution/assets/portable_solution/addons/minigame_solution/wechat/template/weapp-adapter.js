...
/***/ (function (module, exports, __webpack_require__) {
        ...
        const HTMLElement = (function (_Element) {
            ...
            _createClass(HTMLElement, [{
                ...
                value: function getBoundingClientRect() {
                    const width = _WindowProperties.innerWidth
                    const height = _WindowProperties.innerHeight
                    return {
                        x: 0,
                        y: 0,
                        top: 0,
  ...
  /***/ (function (module, exports, __webpack_require__) {
        ...
        function normalizeTouchPoint(touch) {
            const clientX = touch.clientX !== undefined ? touch.clientX : (touch.pageX !== undefined ? touch.pageX : (touch.x !== undefined ? touch.x : 0))
            const clientY = touch.clientY !== undefined ? touch.clientY : (touch.pageY !== undefined ? touch.pageY : (touch.y !== undefined ? touch.y : 0))
            return Object.assign({}, touch, {
                clientX,
                clientY,
                pageX: touch.pageX !== undefined ? touch.pageX : clientX,
                pageY: touch.pageY !== undefined ? touch.pageY : clientY
            })
        }

        function normalizeTouches(list) {
            return Array.prototype.slice.call(list || []).map(normalizeTouchPoint)
        }
        ...
        function touchEventHandlerFactory(type) {
            return function (event) {
                ...
                touchEvent.touches = normalizeTouches(event.touches)
                touchEvent.targetTouches = normalizeTouches(event.touches)
                touchEvent.changedTouches = normalizeTouches(event.changedTouches)
